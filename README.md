# Tension Factor
**Bayesian-evidence based measure for comparing two datasets**

This repository contains some some the code and scripts used to calculate the evidences to obtain the new statistical measure for the papaer `arXiv:1806.xxxxx`.
